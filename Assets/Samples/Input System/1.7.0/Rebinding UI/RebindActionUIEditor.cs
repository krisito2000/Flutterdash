...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_DuplicateBindingTextProperty = serializedObject.FindProperty("m_DuplicateBindingText");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_DuplicateBindingTextProperty);
            }
        ...
        private SerializedProperty m_DuplicateBindingTextProperty;
